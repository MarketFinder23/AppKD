...
class CardsProductSimilars extends GetView<ProductViewController> {
  const CardsProductSimilars({super.key});

  @override
  Widget build(BuildContext context) {
    // Construção dos cards de produtos similares
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: SizedBox(
            width: Get.width * 0.9,
            child: Text(
              "O mesmo produto, outros lugares:",
        ...
        // Lista horizontal de cartões de produtos similares
        SizedBox(
          height: Get.height * 0.35,
          child: Obx(() {
            if (controller.similarProducIsLoading.value) {
              ...
              return SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                    controller.productsSimilarCards.length,
                    (index) {
                      final product = controller.productsSimilarCards[index];
                      return Padding(
